...
- [Methods](#methods)
  ...
  - [getAssets(params?: GetAssetsParams)](#getassetsparams)
  - [getAnAssetByIDorSymbol(param: GetAnAssetByIDorSymbol)](#getananassetbyidor)
  - [getOptionContracts(param?: GetOptionContracts)](#getoptioncontracts)
  - [getOptionContractByIDorSymbol(param: GetOptionContractByIDorSymbol)](#getoptioncontractbyidor)
  - [getSpecificAnnouncement(id: string)](#getspecificannouncement)
  - [getAnnouncements(param: GetAnnouncements)](#getannouncements)
  - [createAnOrder(param: CreateAnOrder)](#createanorder)
  - [getAllOrders(param: GetAllOrders)](#getallorders)
  - [deleteAllOrders()](#deleteallorders)
  - [getOrderById(param: GetOrderById)](#getorderbyid)
  - [replaceOrderbyID(param: ReplaceOrderbyID)](#replaceorderbyid)
  - [deleteOrderbyID(param: DeleteOrderbyID)](#deleteorderbyid)
  - [getAllOpenPositions()](#getallopenpositions)
  - [closeAllPositions(param: CloseAllPositions)](#closeallpositions)
  - [getOpenPosition(param: GetOpenPosition)](#getopenposition)
  - [closePosition(param: ClosePosition)](#closeposition)
  - [exerciseOptionPosition(param: ExerciseOptionPosition)](#exerciseoptionposition)
  - [getPortfolioHistory(param: GetAccountPortfolioHistory)](#getportfoliohistoryparam)
  - [getAllWatchlists()](#getallwatchlists)
  - [createWatchlist(data: CreateWatchlist)](#createwatchlistdata)
  - [getWatchlistbyID(id: GetWatchlistbyID)](#getwatchlistbyidid)
  - [updateWatchlistById(id: UpdateWatchlistById)](#updatewatchlistbyidid)
  - [addAssettoWatchlist(id: AddAssettoWatchlist)](#addassetto)
  - [deleteWatchlistById(id: DeleteWatchlistById)](#deletewatchlistbyidid)
  - [getWatchlistbyName(name: GetWatchlistbyName)](#getwatchlistbyname)
  - [updateWatchlistByName(name: UpdateWatchlistByName)](#updatewatchlistbyname)
  - [addAssettoWatchlistByName(name: AddAssettoWatchlistByName)](#addassetto)
  - [deleteWatchlistByName(name: DeleteWatchlistByName)](#deletewatchlistbyname)
  - [deleteSymbolfromWatchlist(id: DeleteSymbolfromWatchlist)](#deletesymbolfromwatchlistid)
  - [getAccountConfigurations()](#getaccountconfigurations)
  - [updateAccountConfigurations(data: AccountConfigurations)](#updateaccountconfigurationsdata)
  - [getMarketCalendarinfo(param?: GetMarketCalendarinfo)](#getmarketcalendarinfoparam)
  - [ClockAndCalendar()](#clockandcalendar)
  - [getRetrieveCryptoFundingWallets(param: GetRetrieveCryptoFundingWallets)](#getretrievecryptofundingwalletsparam)
  - [getRetrieveCryptoFundingTransfer()](#getretrievecryptofundingtransfer)
  - [requestNewWithdrawal(data: RequestNewWithdrawal)](#requestnewwithdrawaldata)
  - [getRetrieveSingleCryptoFundingTransfer(queryParams: GetRetrieveCryptoFundingTransfer)](#getretrievesinglecryptofundingtransferqueryparams)
  - [getArrayofWhitelistedAddresses(queryParams: GetRetrieveCryptoFundingWallets)](#getarrayofwhitelistedaddressesqueryparams)
  - [requestNewWhitelistedAddress(data: RequestNewWhitelistedAddress)](#requestnewwhitelistedaddressdata)
  - [deleteWhitelistedAddress(data: DeleteWhitelistedAddress)](#deletewhitelistedaddressdata)
  - [getEstimatedGasFee(queryParams: GetEstimatedGasFee)](#getestimatedgasfeequeryparams)
  - [getHistoricalCryptoFunding(queryParams: GetHistoricalAuctions)](#gethistoricalcryptofundingqueryparams)
  - [getHistoricalBars(queryParams: GetHistoricalBars)](#gethistoricalbarsqueryparams)
  - [getLatestBars(queryParams: GetLatestBars)](#getlatestbarsqueryparams)
  - [getConditionCodes(queryParams: GetConditionCodes)](#getconditioncodesqueryparams)
  - [getHistoricalQuotes(param: GetHistoricalQuotes)](#gethistoricalquotesparam)
  - [getLatestQuotes(param: GetLatestQuotes)](#getlatestquotesparam)
  - [getSnapshots(param: GetSnapshots)](#getsnapshotsparam)
  - [getHistoricalTrades(param: GetHistoricalTrades)](#gethistoricaltradesparam)
  - [getLatestTrades(param: GetLatestTrades)](#getlatesttradesparam)
  - [getHistoricalAuctionsSingleSymbol(param: GetHistoricalAuctionsSingleSymbol)](#gethistoricalauctionssinglesymbolparam)
  - [getHistoricalBarsSingleSymbol(param: GetHistoricalBarsSingleSymbol)](#gethistoricalbarssinglesymbolparam)
  - [getLatestBarSingleSymbol(param: GetLatestBarSingleSymbol)](#getlatestbarsinglesymbolparam)
  - [getHistoricalQuotesSingleSymbol(param: GetHistoricalQuotesSingleSymbol)](#gethistoricalquotessinglesymbolparam)
  - [getLatestQuoteSingleSymbol(param: GetLatestQuoteSingleSymbol)](#getlatestquotesinglesymbolparam)
  - [getSnapshotSingleSymbol(param: GetSnapshotSingleSymbol)](#getsnapshotsinglesymbolparam)
  - [getHistoricalTradesSingleSymbol(param: GetHistoricalTradesSingleSymbol)](#gethistoricaltradessinglesymbolparam)
  - [getLatestTradeSingleSymbol(param: GetLatestTradeSingleSymbol)](#getlatesttradesinglesymbolparam)
